...
#x cp make_xml.py /c/xampp/htdocs/cologne/csl-pywork/v02/makotemplates/pywork/make_xml.py
#x cp basicadjust.php /c/xampp/htdocs/cologne/csl-websanlexicon/v02/makotemplates/web/webtc/basicadjust.php

#x cp basicadjust.php /c/xampp/htdocs/cologne/csl-apidev/basicadjust.php
...
#x echo "RESTORE make_xml.py"
#x cd  /c/xampp/htdocs/cologne/csl-pywork/
#git status
#x git restore .
#git status
