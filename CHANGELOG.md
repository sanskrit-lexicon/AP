...
All notable changes to AP are documented here.
...
- Recorded the current repository purpose: Collaborative tools for parsing, validating, and improving the digitised Apte Sanskrit-English dictionary, as part of the Sanskrit Lexicon project.
