...
AP is part of the [Sanskrit Lexicon](https://github.com/sanskrit-lexicon) project — corrections and enhancements for the Cologne digitisation of *Apte Sanskrit–English Dictionary*.
...
Corrections are never made directly to source files — they are expressed as change files applied by scripts. See [`CLAUDE.md`](https://github.com/sanskrit-lexicon/AP/blob/main/CLAUDE.md) for the change-file format and the `updateByLine.py` workflow.
